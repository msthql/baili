...
public class SixDiligence implements Serializable{
	...
	public SixDiligence(Integer id, List<Menus> menus, List<Types> types, Date date, String department,
			String staffName, String clockIn, String bookNames, String chapters, String ceshi, List<Works> works) {
		super();
		this.id = id;
		this.menus = menus;
		this.types = types;
